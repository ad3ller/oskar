...
\item LabVIEW 2013 (or higher)  [written using 32-bit Labview on 64-bit Windows 7]
	 \begin{itemize}
	 	...
	 	\item NI Vision Acquisition Software (for camera example) [tested using a Logitech webcam]
